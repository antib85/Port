	...
	: buffer_(_buffer)
{
	...
	case MessageId::RankRequest:
		...
		break;
	case MessageId::PostRequest:
		Message_ = std::make_shared<PostRequestMessage>();
		break;
	case MessageId::PostLetter:
		Message_ = std::make_shared<PostLetterMessage>();
		break;
	...
	case MessageId::UserRankWindowData:
		...
		break;
	case MessageId::UserPost:
		Message_ = std::make_shared<UserPostMessage>();
		break;
	case MessageId::Chat:
