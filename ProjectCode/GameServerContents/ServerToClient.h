...
class UserPostMessage : public GameServerMessage                    
{                                                               
public:                                                         
	std::string ToNickName;
	std::vector<FPostData> Posts;
                                                                
public:                                                         
    UserPostMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::UserPost))                    
        , ToNickName()
        , Posts()
    {                                                           
    ...
    virtual ~UserPostMessage() {}                                   
                                                                
    virtual int SizeCheck()                                     
    {                                                           
		return DataSizeCheck(ToNickName) + DataSizeCheck(Posts);
    }                                                           
