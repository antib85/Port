...
{																																													
	...
	Dis.AddHandler(static_cast<uint32_t>(MessageId::PostRequest), std::bind(&OnMessageProcess<ThreadHandlerPostRequestMessage, PostRequestMessage>, std::placeholders::_1, std::placeholders::_2));	
	Dis.AddHandler(static_cast<uint32_t>(MessageId::PostLetter), std::bind(&OnMessageProcess<ThreadHandlerPostLetterMessage, PostLetterMessage>, std::placeholders::_1, std::placeholders::_2));	
