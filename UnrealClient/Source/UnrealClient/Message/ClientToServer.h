...
class PostRequestMessage : public GameServerMessage                    
{                                                               
public:                                                         
	std::string NickName;
...
public:                                                         
    PostRequestMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::PostRequest))                    
        , NickName()
    {                                                           
                                                                
    }                                                           
                                                                
    virtual ~PostRequestMessage() {}                                   
...
class PostLetterMessage : public GameServerMessage                    
{                                                               
public:                                                         
...
public:                                                         
    PostLetterMessage()                                               
        : GameServerMessage(static_cast<uint32_t>(MessageId::PostLetter))                    
        , ToNickName()
        , Letters()
        , FromNickName()
    {                                                           
    ...
    virtual ~PostLetterMessage() {}                                   
                                                                
    virtual int SizeCheck()                                     
    {                                                           
		return DataSizeCheck(ToNickName) + DataSizeCheck(Letters) + DataSizeCheck(FromNickName);
    }                                                           
                                                                
    void Serialize(GameServerSerializer& _Serializer)           
    {                                                           
        GameServerMessage::Serialize(_Serializer);              
        _Serializer << ToNickName;
        _Serializer << Letters;
        _Serializer << FromNickName;
